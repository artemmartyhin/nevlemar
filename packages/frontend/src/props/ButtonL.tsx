...
const CustomButton = styled(Button)<CustomButtonProps>(({ theme, buttonType, iconOnly }) => ({
  color: buttonType === 'default' ? '#ffffff' : '#00172d',
  borderRadius: 57,
  ...
  backgroundColor: buttonType === 'default' ? '#00172d' : 'transparent',
  '&:hover': {
...
export const ButtonL: React.FC<CustomButtonProps> = ({ buttonType, iconLeft, iconRight, iconOnly, onClick, ...props }) => {
  return (
    <CustomButton
